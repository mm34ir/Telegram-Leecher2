...
# @markdown <center><h4><a href="https://github.com/XronTrix10/Telegram-Leecher2/wiki/INSTRUCTIONS">READ</a> How to use</h4></center>
...
cmd = "git clone https://github.com/XronTrix10/Telegram-Leecher2 && bash /content/Telegram-Leecher/setup.sh"
